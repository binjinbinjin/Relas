...
describe('Service Tests', () => {
    ...
    describe('UnreadChatMessageMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UnreadChatMessageMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/unread-chat-messages';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UnreadChatMessageMySuffix', () => {
