...
describe('Service Tests', () => {
    ...
    describe('ChatMessageMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ChatMessageMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/chat-messages';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ChatMessageMySuffix', () => {
