...
describe('Service Tests', () => {
    ...
    describe('DatingRecordMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DatingRecordMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/dating-records';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DatingRecordMySuffix', () => {
