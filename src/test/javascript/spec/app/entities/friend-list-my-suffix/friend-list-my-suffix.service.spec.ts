...
describe('Service Tests', () => {
    ...
    describe('FriendListMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(FriendListMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/friend-lists';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return FriendListMySuffix', () => {
