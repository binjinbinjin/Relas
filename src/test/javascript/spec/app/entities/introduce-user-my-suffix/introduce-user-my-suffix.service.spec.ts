...
describe('Service Tests', () => {
    ...
    describe('IntroduceUserMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(IntroduceUserMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/introduce-users';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return IntroduceUserMySuffix', () => {
