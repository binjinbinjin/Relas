...
describe('Service Tests', () => {
    ...
    describe('ChatRoomMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ChatRoomMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/chat-rooms';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ChatRoomMySuffix', () => {
