...
describe('Service Tests', () => {
    ...
    describe('UserPortfolioMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UserPortfolioMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-portfolios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserPortfolioMySuffix', () => {
